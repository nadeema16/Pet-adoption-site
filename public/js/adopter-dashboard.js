document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
                ...
                <div class="application-card">
                    ...
                    ${app.show_contact ? `
                        <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #ddd;">
                            <p><strong>Shelter Contact:</strong></p>
                            <p>Email: ${app.shelter_email}</p>
                            <p>Phone: ${app.shelter_phone || 'N/A'}</p>
                        </div>
                    ` : ''}
                </div>
            `;
        ...
        container.innerHTML = '<div class="error-message">Error loading applications. Please try again later.</div>';
    }
});